  ...
  return (
    <main className="flex flex-col items-center font-rem font-bold py-8">
      ...
      <p className="px-28 mb-7 text-center">
        ...
        I graduated from the UCONN Coding Bootcamp in July 2023. 
        Take a look at my top projects displayed in the portfolio page. 
        You will find links to the deployed applications and the corresponding GitHub repositories. 
      ...
      <p className="px-28 text-center">
        ...
        photography, design, and reading.
      </p>
    </main>
  );
}
